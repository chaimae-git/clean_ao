<div class="modal fade" wire:ignore.self id="addDocumentTechniqueModal">
    <div class="modal-dialog" data-backdrop='static' data-keyboard='false'>
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formAddDocumentTechniqueModal" enctype="multipart/form-data" wire:submit.prevent="saveDocumentTechnique">
                    @csrf
