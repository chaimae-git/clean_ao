<div class="modal fade" wire:ignore.self id="addDocumentAdministratifModal">
    <div class="modal-dialog" data-backdrop='static' data-keyboard='false'>
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formAddDocumentAdministratifModal" enctype="multipart/form-data" wire:submit.prevent="saveDocumentAdministratif">
                    @csrf
